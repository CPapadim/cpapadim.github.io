...
<img width=99px src = "https://github.com/CPapadim/cpapadim.github.io/raw/master/other/Photo25.png"></img>  | I'm a `quantitative storyteller`.  I enjoy taking strings of words in the form of questions, turning them into numbers and math, using data to find quantitative answers, and finally turning those quantitative answers into compelling stories.
------------ | -------------
